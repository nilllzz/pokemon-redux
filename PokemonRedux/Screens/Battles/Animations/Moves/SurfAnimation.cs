...
{
    internal class SurfAnimation : BattleAnimation
    {
        ...
        public SurfAnimation(BattlePokemon target)
        {
            _target = target;
        }
        ...
        {
            _texture = Controller.Content.LoadDirect<Texture2D>("Textures/Battle/Animations/surf.png");
